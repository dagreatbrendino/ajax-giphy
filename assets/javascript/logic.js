$(document).ready(function(){
    //array of topics
    var topics = ["mario","solid snake","marcus fenix","booker dewit","gordon freeman",
    ...
    var getGifs = function (term) {
        ...
        $.ajax({
            ...
            for (var j = 0; j < gifs.length; j++) {
                $("#gif-container").append("<div><img class=img-fluid src=https://media.giphy.com/media/" + gifs[j] + "/giphy.gif />");
            }
        });
    }
